...
scenario("send pending test", async (s, t) => {
    ...
    // const check_result1 = await billy.call("app", "snapmail", "check_incoming_mail", {})
...
//
scenario("send via DM test", async (s, t) => {
...
//
scenario("get all mails test", async (s, t) => {
